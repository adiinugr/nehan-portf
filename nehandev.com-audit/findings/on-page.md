...
## Critical: 7 indexed URLs share one identical title/description/canonical (all point to home)
...
## High: Duplicated "| NehanDev" suffix in title tags on 4 pages
...
## High: `/layanan` (the main services/commercial page) has no page-specific metadata at all
...
## Medium: Missing `<h1>` on 3 indexed pages
